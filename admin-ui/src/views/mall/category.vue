  ...
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item v-if="dataForm.level === 'L3'" label="父类目" prop="pid">
          <el-cascader :options="catL2" expand-trigger="hover" @change="handleCategoryChange"/>
        </el-form-item>
...
export default {
  ...
  methods: {
    getList() {
      cat2().then(response => {
        this.catL2 = response.data.data.categoryList
      })
