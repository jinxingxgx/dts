...
<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" size="small" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="品牌商地址" prop="address" />
      <el-table-column align="center" label="类目" prop="categroyName" />
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-position="left" label-width="100px" style="width: 800px; margin-left:50px;">
        ...
        <el-form-item label="当前排序（0表示置顶）" prop="sortOrder">
...
export default {
  ...
  methods: {
    ...
    handleCategoryChange(value) {
      ...
      console.info(this.dataForm.defaultCategoryId)
    },
    handleFilter() {
    ...
    handleUpdate(row) {
      ...
      this.dataForm.defaultCategoryId = row.defaultCategoryId
