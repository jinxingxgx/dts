...
public class DtsBrand {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId())) && (this.getName() == null ? other.getName() == null : this.getName().equals(other.getName())) && (this.getDesc() == null ? other.getDesc() == null : this.getDesc().equals(other.getDesc())) && (this.getPicUrl() == null ? other.getPicUrl() == null : this.getPicUrl().equals(other.getPicUrl())) && (this.getSortOrder() == null ? other.getSortOrder() == null : this.getSortOrder().equals(other.getSortOrder())) && (this.getFloorPrice() == null ? other.getFloorPrice() == null : this.getFloorPrice().equals(other.getFloorPrice())) && (this.getAddTime() == null ? other.getAddTime() == null : this.getAddTime().equals(other.getAddTime())) && (this.getUpdateTime() == null ? other.getUpdateTime() == null : this.getUpdateTime().equals(other.getUpdateTime())) && (this.getShareUrl() == null ? other.getShareUrl() == null : this.getShareUrl().equals(other.getShareUrl())) && (this.getDeleted() == null ? other.getDeleted() == null : this.getDeleted().equals(other.getDeleted())) && (this.getCommpany() == null ? other.getCommpany() == null : this.getCommpany().equals(other.getCommpany())) && (this.getAutoUpdateGood() == null ? other.getAutoUpdateGood() == null : this.getAutoUpdateGood().equals(other.getAutoUpdateGood())) && (this.getShopUrl() == null ? other.getShopUrl() == null : this.getShopUrl().equals(other.getShopUrl())) && (this.getDefaultCategoryId() == null ? other.getDefaultCategoryId() == null : this.getDefaultCategoryId().equals(other.getDefaultCategoryId())) && (this.getDefaultPages() == null ? other.getDefaultPages() == null : this.getDefaultPages().equals(other.getDefaultPages())) && (this.getAddPrecent() == null ? other.getAddPrecent() == null : this.getAddPrecent().equals(other.getAddPrecent()));
    }
     ...
     */
    public enum Column {
        id("id", "id", "INTEGER", false), name("name", "name", "VARCHAR", true), desc("desc", "desc", "VARCHAR", true), picUrl("pic_url", "picUrl", "VARCHAR", false), sortOrder("sort_order", "sortOrder", "TINYINT", false), floorPrice("floor_price", "floorPrice", "DECIMAL", false), addTime("add_time", "addTime", "TIMESTAMP", false), updateTime("update_time", "updateTime", "TIMESTAMP", false), shareUrl("share_url", "shareUrl", "VARCHAR", false), deleted("deleted", "deleted", "BIT", false), commpany("commpany", "commpany", "VARCHAR", false), autoUpdateGood("auto_update_good", "autoUpdateGood", "BIT", false), shopUrl("shop_url", "shopUrl", "VARCHAR", false), phone("phone", "phone", "VARCHAR", false), address("address", "address", "VARCHAR", false), longitude("longitude", "longitude", "VARCHAR", false), latitude("latitude", "latitude", "VARCHAR", false), defaultCategoryId("default_category_id", "defaultCategoryId", "INTEGER", false), defaultPages("default_pages", "defaultPages", "INTEGER", false), addPrecent("add_precent", "addPrecent", "INTEGER", false);
