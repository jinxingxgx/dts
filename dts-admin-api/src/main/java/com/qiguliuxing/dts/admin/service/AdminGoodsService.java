...
public class AdminGoodsService {
    ...
    public Object list4() {
        ...
        DtsCategory l10 =new DtsCategory();
        l10.setId(1);
        l10.setPid(0);
        l10.setName("首页上");
        l10.setLevel("L1");
        l1CatList.add(l10);
        DtsCategory l11 =new DtsCategory();
        l11.setId(2);
        l11.setPid(0);
        l11.setName("首页下");
        l11.setLevel("L1");
        ...
        for (DtsCategory l1 : l1CatList) {
            ...
            for (DtsCategory l2 : l2CatList) {
                ...
                List<DtsCategory> l3CatList = categoryService.queryByPid(l2.getId());
                List<CatVo> children2 = new ArrayList<>(l2CatList.size());
                for (DtsCategory l3 : l3CatList) {
