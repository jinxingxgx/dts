...
// 测试环境部署api地址
//var WxApiRoot = 'http://192.168.2.238:9990/wx/';
// 线上云平台api地址
var WxApiRoot = 'https://mall.wide580.com/wx/';
...
module.exports = {
  ...
  BrandListWithType: WxApiRoot + 'brand/listWithType', //品牌列表根据类型和当前的条件查询
  AdDetail: WxApiRoot + 'brand/adDetail', //广告详情
  ...
  FriendCicleList: WxApiRoot + 'friendCircle/list', //发表信息
  
  FriendCicleDel: WxApiRoot + 'friendCircle/delete', //删除信息
  
  FriendCicleAdd: WxApiRoot + 'friendCircle/add', //添加信息
  FriendCicleDetail: WxApiRoot + 'friendCircle/detail', //获取出租车详情
  friendCircleCount: WxApiRoot + 'friendCircle/count', //评论总数
