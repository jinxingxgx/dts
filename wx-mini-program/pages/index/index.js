...
Page({
  ...
  onLoad: function(options) {
    qqmapsdk  = new QQMapWX({
      key: '7O6BZ-EOCHP-5VRDY-VX7EB-7A7RF-3SF75'
    })
    this.setData({
      colseCoupon: false
    });
      ...
      success(res) {
        ...
        qqmapsdk.reverseGeocoder({
          ...
          success: function(ress) {
            console.info(ress)
            app.globalData.address=ress.result.formatted_addresses.recommend
          
            that.setData({
              address: ress.result.formatted_addresses.recommend,
